...
public class TC_Books_180 {
	//Validate that user is able to add the product to cart
	public static void main(String[] args) {
		...
		explicitWait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//tr[contains(@class,'cart')]//a"))));
		String added_prdt=driver.findElement(By.xpath("//tr[contains(@class,'cart')]//a")).getText();
		if(selected_prdt.equals(added_prdt))
