...
public class TC_Elec_32 {
	//Validate that "sort" by dropdown should accept Price: Low to High
	public static void main(String[] args) {
		...
		explicitWait.until(ExpectedConditions.titleContains("Cell phones"));
		WebElement orderby=driver.findElement(By.id("products-orderby"));
		Select orderDrp =new Select(orderby);
		orderDrp.selectByVisibleText("Price: Low to High");
		List<WebElement> nameSort=driver.findElements(By.xpath("//span[contains(@class,'actual-price')]"));
